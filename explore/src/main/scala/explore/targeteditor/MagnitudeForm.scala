...
//   magnitudes: View[SortedMap[Band, Magnitude]],
//   disabled:   Boolean
...
//     def fromUsedMagnitudes(magnitudes: SortedMap[Band, Magnitude]): State = {
...
//           val excludeFn: View[Magnitude] => Set[Band] =
...
//         _.widen[Map[Band, Magnitude]].toListOfViews
//       )
